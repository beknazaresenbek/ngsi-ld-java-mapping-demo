...
//        OBJECT_MAPPER.addMixIn(EntityVO.class, EntityVOMixin.class);
    }
    ...
    public void testDemo() throws IOException {
        ...
        String serialized = entityVOMapper.serialize(entityVO);
        System.out.println(serialized);

        EntityVO deserialized = entityVOMapper.deserialize(serialized.getBytes(), EntityVO.class);
